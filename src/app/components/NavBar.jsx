      ...
      <div className="grid grid-cols-3 place-items-center w-full mx-auto px-6 py-4 md:px-20 md:py-6">
        ...
        <div className="flex space-x-4 sm:space-x-8 md:space-x-12">
          ...
          <button
            ...
            className={`relative rounded-full border-2 p-1 transition-colors delay-200 duration-200 ease-in-out ${switchBorderColor} flex justify-center items-center w-6 h-6`}
          >
            <div
              className="absolute flex transition-opacity ease-in-out delay-200 duration-200"
