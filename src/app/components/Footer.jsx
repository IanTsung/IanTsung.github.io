...
const Footer = () => {
  ...
  return (
    <footer className={`footer z-10 border border-t-[#33353F] border-l-transparent border-r-transparent ${textColor}`}>
      <div className="flex justify-center items-center gap-4 md:gap-6 p-12">
        <span className="font-zolasixx text-xl md:text-2xl">
					IAN
        </span>
